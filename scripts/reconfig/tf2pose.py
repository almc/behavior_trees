...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        try:
            (trans_B,rot_B) = listener.lookupTransform('data/multi/patt.letter_a', 'data/multi/patt.letter_b', rospy.Time(0))
            (trans_C,rot_C) = listener.lookupTransform('data/multi/patt.letter_a', 'data/multi/patt.letter_c', rospy.Time(0))
            # trans, (dx, dy, dz)
